...
COPY --from=builder --chown=bridge:nodejs /app/node_modules/.prisma ./node_modules/.prisma
COPY --from=builder --chown=bridge:nodejs /app/prisma ./prisma

# Create logs directory
RUN mkdir -p logs && chown bridge:nodejs logs
